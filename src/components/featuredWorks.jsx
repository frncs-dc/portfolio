    ...
    return (
        <section className="relative z-10 lg:my-24 my-12 flex flex-col gap-4 justify-center">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
                <ScrollReveal className="shrink-0 mx-auto lg:mx-0">
                    <Image
                ...
                <ScrollReveal className="min-w-0 flex-1" delay={90}>
                    <div className="flex flex-col gap-4 h-full">
                        <h2 className="text-2xl font-bold mt-8 lg:mt-0">
                            PisoCAKE
                        </h2>
                        <p className="text-lg text-neutral-500">
            ...
            {/* Food Storage Project — single reveal: reversed column order on mobile */}
            <ScrollReveal>
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
                    <div className="flex flex-col gap-4 order-2 lg:order-1 min-w-0 flex-1">
                        <h2 className="text-2xl font-bold mt-8 lg:mt-0">
                            Food Storage
                        </h2>
                        <p className="text-lg text-neutral-500">
                            ...
                            among household members in meal planning,
                            organization, and grocery shopping, leading the
                            researchers to focus the design problem on how to
                            present information to motivate better collaboration
                            in managing groceries.
                        </p>
                        <div className="flex flex-row flex-wrap gap-2">
                    ...
                    <Image
                        ...
                        width={260}
                        height={500}
                        className="rounded-2xl ml-auto order-1 lg:order-2 shrink-0 mx-auto lg:mx-0
                                hover:scale-110 transition-all duration-300"
                    />
                </div>
            </ScrollReveal>

            <div className="flex flex-col gap-4 lg:flex-row lg:items-start mt-8">
                <ScrollReveal className="shrink-0 mx-auto lg:mx-0">
                    <Image
                ...
                <ScrollReveal className="min-w-0 flex-1" delay={90}>
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-lg text-neutral-500">
                            This portfolio showcases a curated selection of my
                            work, highlighting my skills in development and
                            design. Built with Next.js and Tailwind CSS, it is
                            crafted with performance and SEO best practices in
                            mind.
                        </p>
                        <div className="flex flex-row flex-wrap gap-2">
