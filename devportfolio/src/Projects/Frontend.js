        ...
        <>
            ...
            <Row className='ms-3 mt-3 w-auto' data-aos="fade-up">
                <Col className='col-2 p-2 '>
                    <Carousel>
                        <Carousel.Item>
                            <Image rounded fluid src='portfolio\Projects\TellTail Tasks\TellTail Tasks - 1.png'></Image>
                        </Carousel.Item>
                        <Carousel.Item>
                            <Image rounded fluid src='portfolio\Projects\TellTail Tasks\TellTail Tasks - 2.png'></Image>
                        </Carousel.Item>
                    </Carousel>
                </Col>
                <Col className='ms-2'>
